...
class _$BillingAddressImpl implements _BillingAddress {
  ...
  @override
  String toString() {
    return 'BillingAddress(firstName: $firstName, lastName: $lastName, address1: $address1, address2: $address2, city: $city, countryCode: $countryCode, province: $province, company: $company, postalCode: $postalCode, phone: $phone)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, firstName, lastName, address1,
      address2, city, countryCode, province, company, postalCode, phone);
...
abstract class _BillingAddress implements BillingAddress {
  factory _BillingAddress(
      ...
      final String? phone}) = _$BillingAddressImpl;
