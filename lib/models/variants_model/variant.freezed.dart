...
class _$VariantImpl implements _Variant {
  ...
  @override
  String toString() {
    return 'Variant(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, title: $title, productId: $productId, sku: $sku, barcode: $barcode, ean: $ean, upc: $upc, inventoryQuantity: $inventoryQuantity, allowBackorder: $allowBackorder, manageInventory: $manageInventory, hsCode: $hsCode, originCountry: $originCountry, midCode: $midCode, material: $material, weight: $weight, length: $length, height: $height, width: $width, metadata: $metadata, options: $options, product: $product, prices: $prices, originalPrice: $originalPrice, calculatedPrice: $calculatedPrice, originalPriceInclTax: $originalPriceInclTax, calculatedPriceInclTax: $calculatedPriceInclTax, originalTax: $originalTax, calculatedTax: $calculatedTax, taxRates: $taxRates)';
  }
