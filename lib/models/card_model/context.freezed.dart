...
abstract class $ContextCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? ip, @JsonKey(name: 'user_agent') String? userAgent});
}
...
class _$ContextImpl implements _Context {
  _$ContextImpl({this.ip, @JsonKey(name: 'user_agent') this.userAgent});
  ...
  @override
  String toString() {
    return 'Context(ip: $ip, userAgent: $userAgent)';
  }
...
abstract class _Context implements Context {
  factory _Context(
      {final String? ip,
      @JsonKey(name: 'user_agent') final String? userAgent}) = _$ContextImpl;
