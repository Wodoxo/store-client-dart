...
class _$RegionImpl implements _Region {
  _$RegionImpl(
      ...
      @JsonKey(name: 'tax_rates') final List<dynamic>? taxRates,
      @JsonKey(name: 'fulfillment_providers')
  ...
  @override
  String toString() {
    return 'Region(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, name: $name, currencyCode: $currencyCode, taxRate: $taxRate, taxCode: $taxCode, giftCardsTaxable: $giftCardsTaxable, automaticTaxes: $automaticTaxes, taxProviderId: $taxProviderId, metadata: $metadata, countries: $countries, paymentProviders: $paymentProviders, taxRates: $taxRates, fulfillmentProviders: $fulfillmentProviders)';
  }
