...
class _$ProductCategoryImpl implements _ProductCategory {
  ...
  @override
  String toString() {
    return 'ProductCategory(createdAt: $createdAt, description: $description, handle: $handle, id: $id, metadata: $metadata, name: $name, parentCategoryId: $parentCategoryId, rank: $rank, updatedAt: $updatedAt, categoryChildren: $categoryChildren, parentCategory: $parentCategory)';
  }
